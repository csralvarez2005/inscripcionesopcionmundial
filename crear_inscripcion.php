...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $requiredFields = [
        ...
        'edad', 'victima', 'hastaQueGrado', 'programaEstudio', 
        'personaPostula', 'nombrePostula', 'telefonoPostula', 'correoPostula'
    ];
    ...
    $inscripcion->personaPostula = htmlspecialchars(strip_tags($_POST['personaPostula']));
